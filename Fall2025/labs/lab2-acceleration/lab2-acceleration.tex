...
\begin{itemize}
\setlength{\parskip}{3pt}
\item Section 1.2: One velocity-time and one acceleration-time graph with short descriptions. Include your calculated velocity and acceleration on the same graph with the velocity and acceleration given to you by LoggerPro [6 pts]
